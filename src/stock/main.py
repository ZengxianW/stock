...
result=result.rename(columns={'code':'index_code','pctChg':'change','amount':'money'})

#### 结果集输出到csv文件 ####
result.to_csv('./data/data3.csv', encoding="utf-8",index=None)
...
class Config:
    ...
    # 路径参数
    train_data_path = "./data/data3.csv"
